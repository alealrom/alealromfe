  ...
  <div class="container-fluid col-12 col-lg-4">
    <div class="contacto">
      ...
      <div class="row row-cols-2 row-cols-lg-2 g-2 g-lg-2">
        ...
        <div class="col">
          <p class="cont-info">+57 324 682 20 91</p>
      ...
      <div>
         <center><img
          class="logo"
          v-bind:src="require('../assets/logo_alealrom.png')"
          alt="Foto Alejandra Álvarez Romero"
        /></center>
          ...
          <li class="ms-3 con-icon">
            <a class="icon" target="_blank" href="https://twitter.com/alealrom"
              ><svg
                xmlns="http://www.w3.org/2000/svg"
                width="32"
                height="32"
          ...
          <li class="ms-3 con-icon">
            <a class="icon" target="_blank" href="https://github.com/alealrom/"
              ><svg
                xmlns="http://www.w3.org/2000/svg"
                width="32"
                height="32"
...
.base {
  border-bottom: solid 2px #f0a500;
  margin: 20px auto;
  max-width: 80%;
}
